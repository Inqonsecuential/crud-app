...
const Index = ({ employees }: any) => {
  ...
  return (
    <>
      ...
      {open && <Form open={open} closeForm={closeForm} employee={employee} />}
      {employee && openDelete && (
        <Delete
      ...
      {status === 'authenticated' ? (
        ...
        <div className=' w-full h-[80vh] flex items-center justify-center'>
          <div className='text-center text-razzle-dazzle-rose-700 font-content'>
            You are not authorized to view this page. Please{' '}
            <Link
              href='/auth/login'
              className='hover:underline hover:font-semibold text-electric-violet-700 font-medium'
            >
              Login
            </Link>{' '}
            here
